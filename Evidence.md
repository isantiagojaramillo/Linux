...
![](docs/media/Pictures/100000010000032A00000065CBBC6153.png){width="6.9252in"
height="0.8634in"}
...
![](docs/media/Pictures/100000010000032A000000655B1B5E5C.png){width="6.9252in"
height="0.8634in"}
...
![](docs/media/Pictures/10000001000002C40000018B13CEFFEB.png){width="6.9252in"
height="3.8634in"}
...
![](docs/media/Pictures/10000001000002C4000000F7DEDC2906.png){width="6.9252in"
height="2.4154in"}

5\. Una vez dentro del directorio, creamos un archivo .txt

![](docs/media/Pictures/10000001000002C40000005A892753A6.png){width="6.9252in"
height="0.8799in"}

6\. Lo abrimos haciendo uso del editor nano

![](docs/media/Pictures/10000001000002F4000000356340DD0B.png){width="6.9252in"
height="0.4854in"}

![](docs/media/Pictures/10000001000003DC0000023F83FDACA2.png){width="6.9252in"
height="4.0299in"}

7\. Verificamos los permisos del los archivos:

![](docs/media/Pictures/10000001000002F400000078AC346195.png){width="6.9252in"
height="1.0984in"}\
Podemos ver que el usuario tiene permiso de lectura y escritura.

8\. Cambiamos permisos

![](docs/media/Pictures/10000001000003D00000016DDB46C896.png){width="6.9252in"
height="2.5898in"}\
